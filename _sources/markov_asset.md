...
We give examples of some models of stochastic discount factors that have been proposed later in this lecture and also in a [separate lecture](https://jax.quantecon.org/lucas_model.html).
...
(A derivation of this expression is given in a [separate lecture](https://jax.quantecon.org/lucas_model.html))
